...
<head>
    ...
    <link href="{{ asset('assets/images/icons/favicon.ico') }}" rel="shortcut icon" />
    <title>K24 Test App</title>
    <!--begin::Fonts-->
...
<!--end::Head-->
<!--begin::Body-->
<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="noBack();" id="kt_body" class="header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable" data-scrolltop="on">
<!--begin::Main-->
<!--begin::Header Mobile-->
<div id="kt_header_mobile" class="header-mobile">
    <!--begin::Logo-->
    <a href="#">
        <img alt="Logo" src="{{ asset('assets/images/k24klik_logo2.png') }}" class="max-h-65px" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    &nbsp;&nbsp;<span class="text-muted font-weight-bold mr-2">&nbsp;&nbsp;2023 ©</span>
                        <a href="{{ url('Home/home') }}" target="_blank" class="text-dark-50 text-hover-primary">Paulinus P. Dwi Yulianto</a>
                    </div>
                    <!--end::Copyright-->
                </div>
                <!--end::Container-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-75 mr-3">
                <div class="symbol-label" style="background-image:url('{{ url('storage/uploads/'.$nama_file_foto) }}')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <span class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Session::get('realname') }}</span>

                <div class="text-muted mt-1">{{ Session::get('full_name') }}</div>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
			@if ((Session::get('username') !== "demo@datawhiz.co.id"))
